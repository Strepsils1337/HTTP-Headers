...
if (isset($_REQUEST['name'])) {
    ...
    $query = "INSERT INTO `php.tasks` ( `name`, `country`, `gеnre`, `dateCreate`, `budget`, `directorName`, `directorLast`)  VALUES ('$name', '$country',  '$gеnre', '$dateCreate',  '$budget ', '$directorName', '$directorLast')";
    $resul = mysqli_query($link, $query) or die(mysqli_error($link));
